...
class Template extends Base
{
  ...
  * @readwrite
  */
  protected string $_header = "if (is_array(\$_data) && sizeof(\$_data)) extract(\$_data); \$_text = array();";
  ...
  */
  ...
  protected function _arguments(string $source, array $expression): array
  {
  ...
  protected function _script(array $tree): string
  {
    $content = array();
  ...
  public function process(array $data): ?object
  {
